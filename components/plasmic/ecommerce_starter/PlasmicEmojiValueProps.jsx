...
import Value from "../../Value"; // plasmic-import: DdGhFwBcvqnZ/component
...
import * as sty from "./PlasmicEmojiValueProps.module.css"; // plasmic-import: yvGxdpW5fqaU/css
import Icon12Icon from "./icons/PlasmicIcon__Icon12"; // plasmic-import: aGIoWgjZR0Fv/icon
import Icon13Icon from "./icons/PlasmicIcon__Icon13"; // plasmic-import: dLk2hq3jlDUm/icon
import Icon14Icon from "./icons/PlasmicIcon__Icon14"; // plasmic-import: kgAPB2VqoRW4/icon
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.freeBox___8O0D)}
          >
            <Value
              className={classNames("__wab_instance", sty.value__qe5J6)}
              slot={
                <Icon12Icon
                  className={classNames(defaultcss.all, sty.svg__e3EYb)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              className={classNames("__wab_instance", sty.value___58Ctw)}
              slot={
                <Icon13Icon
                  className={classNames(defaultcss.all, sty.svg__aFll8)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              className={classNames("__wab_instance", sty.value___15Sqt)}
              slot={
                <Icon14Icon
                  className={classNames(defaultcss.all, sty.svg___16VZx)}
                  role={"img"}
                />
              }
            >
